...
const Admin = () => {
	...
	const ALLOWED_TABS = ["home", "blogs", "emails", "subscribers", "analytics"];
	...
	// Ensure active tab is always valid for this blog-kit preset
	useEffect(() => {
				...
				<main className="flex-1 w-full h-full overflow-y-auto">
					<div className="h-full w-full md:p-2">
						<div className="h-full w-full bg-white border border-zinc-200 rounded-2xl py-2 overflow-y-auto">
							...
							{/* blog-kit preset: removed other tabs */}
						</div>
					</div>
				</main>
			</div>
